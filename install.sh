...
#
# 用法（任选其一，脚本托管于 GitHub 公开仓库，与作者个人服务器/域名完全无关）：
...
#   方式B — 下载到本地再执行：
#     curl -sL https://raw.githubusercontent.com/daiqiongzhao-bit/GZT/main/install.sh -o gzt-install.sh && bash gzt-install.sh
#
